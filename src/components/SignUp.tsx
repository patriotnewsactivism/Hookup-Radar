        ...
        <CardContent className="pt-6">
          ...
          >
            <div className="space-y-2">
              ...
              <Input id="name" name="name" type="text" placeholder="Your name" autoComplete="name" className="h-11" required />
            </div>
            <div className="space-y-2">
    ...
    <Card variant="elevated">
      <CardContent className="pt-6">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-muted-foreground">We sent a verification code to {step.email}</p>
        </div>
        <form
          onSubmit={async e => {
            e.preventDefault();
        ...
        >
          <div className="space-y-2">
            ...
            <Input id="code" name="code" type="text" placeholder="Enter code" autoComplete="one-time-code" className="h-11 text-center tracking-[0.5em] font-mono" required />
          </div>
