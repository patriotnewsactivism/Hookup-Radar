...
function mapProfile(viewer: any): SurgeUser | null {
  ...
  return {
    ...
    boost_expires_at: viewer.boost_expires_at || '',
    badges: viewer.badges || [],
    referral_code: viewer.referral_code || '',
    referrer_id: viewer.referrer_id || '',
    total_invites_sent: viewer.total_invites_sent ?? 0,
    total_referrals: viewer.total_referrals ?? 0,
    total_free_days_earned: viewer.total_free_days_earned ?? 0,
    current_streak: viewer.current_streak ?? 0,
    last_active_date: viewer.last_active_date || '',
    email_confirmed_at: viewer.email_confirmed_at || '',
